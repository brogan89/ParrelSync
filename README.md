...
- Removed copying Packages folder and replaced it with symlinking. PR [#63](https://github.com/VeriorPies/ParrelSync/pull/63)

### Install

```json
    "com.veriorpies.parrelsync": "https://github.com/brogan89/ParrelSync.git?path=ParrelSync",
```
